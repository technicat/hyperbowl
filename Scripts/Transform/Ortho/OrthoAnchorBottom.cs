...
public class OrthoAnchorBottom : MonoBehaviour {
...
//		float dist = 0.1f; // transform.localPosition.y + 0.5f-0.1f; //  - ortho/2
		...
		float offset = (1.0f-transform.localPosition.y)/aspect;
		transform.localPosition = new Vector3( transform.localPosition.x, 1.0f-offset, transform.localPosition.z);
	}
